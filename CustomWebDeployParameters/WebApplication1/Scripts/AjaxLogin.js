$(function () {
    ...
    // Select all links under #login with data-dialog-title attributes
    $('#login a[data-dialog-title]').click(function (e) {
        var link = $(this),
            url = link.attr('href'),
            id = link.attr('id');

        if (document.documentElement.offsetWidth <= 850) {
            // We're in mobile layout, so just no-op and return
            return;
        }
